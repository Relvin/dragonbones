...
inline std::string getStringByDisplayerType(DisplayType displayType)
{
    if (displayType == DisplayType::DT_IMAGE)
    {
        return "image";;
    }
    else if (displayType == DisplayType::DT_ARMATURE)
    {
        return "armature";;
    }
    else if (displayType == DisplayType::DT_FRAME)
    {
        return "frame";
    }
    else if (displayType == DisplayType::DT_TEXT)
    {
        return "text";
    }
...
inline DisplayType getDisplayTypeByString(const std::string &displayType)
{
...
inline std::string getStringByBlendMode(BlendMode blendMode)
{
    if (blendMode == BlendMode::BM_NORMAL)
    {
        return "normal";
    }
    else if (blendMode == BlendMode::BM_ADD)
    {
        return "add";
    }
    else if (blendMode == BlendMode::BM_ALPHA)
    {
        return "alpha";
    }
    else if (blendMode == BlendMode::BM_DARKEN)
    {
        return "darken";
    }
    else if (blendMode == BlendMode::BM_DIFFERENCE)
    {
        return "difference";
    }
    else if (blendMode == BlendMode::BM_ERASE)
    {
        return "erase";
    }
    else if (blendMode == BlendMode::BM_HARDLIGHT)
    {
        return "hardLight";
    }
    else if (blendMode == BlendMode::BM_INVERT)
    {
        return "invert";
    }
    else if (blendMode == BlendMode::BM_LAYER)
    {
        return "layer";
    }
    else if (blendMode == BlendMode::BM_LIGHTEN)
    {
        return "lighten";
    }
    else if (blendMode == BlendMode::BM_MULTIPLY)
    {
        return "multiply";
    }
    else if (blendMode == BlendMode::BM_OVERLAY)
    {
        return "overlay";
    }
    else if (blendMode == BlendMode::BM_SCREEN)
    {
        return "screen";
    }
    else if (blendMode == BlendMode::BM_SHADER)
    {
        return "shader";;
    }
    else if (blendMode == BlendMode::BM_SUBTRACT)
    {
        return "subtract";
    }
