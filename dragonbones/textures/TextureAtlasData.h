#ifndef DRAGONBONES_TEXTURES_TEXTURE_ATLAS_DATA_H
#define DRAGONBONES_TEXTURES_TEXTURE_ATLAS_DATA_H
...
public:
    ...
    void setAutoSearch (bool autoSeatch)
    {
        this->autoSearch = autoSeatch;
    }
