...
SlotTimelineState* SlotTimelineState::borrowObject()
{
	if (_pool.empty())
	{
	...
	SlotTimelineState *timelinseState = _pool.back();
	_pool.pop_back();
	return timelinseState;
}

void SlotTimelineState::returnObject(SlotTimelineState *timelineState)
{
...
void SlotTimelineState::clearObjects()
{
...
void SlotTimelineState::fadeIn(Slot *slot, AnimationState *animationState, SlotTimeline *timelineData)
{
	_slot = slot;
...
void SlotTimelineState::update(float progress)
{
	if (_updateMode == -1)
	{
...
void SlotTimelineState::updateMultipleFrame(float progress)
{
...
void SlotTimelineState::updateToNextFrame(int currentPlayTimes)
{
...
void SlotTimelineState::updateSingleFrame()
{
