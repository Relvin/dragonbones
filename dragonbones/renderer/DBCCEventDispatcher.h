#ifndef DRAGONBONES_RENDERER_DBCC_EVENT_DISPATCHER_H
#define DRAGONBONES_RENDERER_DBCC_EVENT_DISPATCHER_H
...
#endif  // DRAGONBONES_RENDERER_DBCC_EVENT_DISPATCHER_H
