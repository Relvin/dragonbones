...
#ifndef DB_TINYXML2_INCLUDED
#define DB_TINYXML2_INCLUDED
...
inline int DBTIXML_SNPRINTF(char *buffer, size_t size, const char *format, ...)
{
    va_list va;
    va_start(va, format);
...
#define DBTIXML_SSCANF   sscanf_s
#else
// GCC version 3 and higher
//#warning( "Using sn* functions." )
#define DBTIXML_SNPRINTF snprintf
#define DBTIXML_SSCANF   sscanf
#endif

static const int DBTIXML2_MAJOR_VERSION = 1;
static const int DBTIXML2_MINOR_VERSION = 0;
static const int DBTIXML2_PATCH_VERSION = 9;
